...
class IchimokuCloudStrategy(TradingStrategy):
    ...
    def execute(self):
        print(
            f"Executing Ichimoku Cloud strategy with conversion line period {self.parameters['conversion_line_period']}, base line period {self.parameters['base_line_period']}, lagging span periods {self.parameters['lagging_span_periods']}, and displacement {self.parameters['displacement']}"
        )
...
class RSIDivergenceStrategy(TradingStrategy):
    ...
    def execute(self):
        print(
            f"Executing RSIDivergence  strategy with signal_period {self.parameters['signal_period']}, long_rsi_period {self.parameters['long_rsi_period']}, short_rsi_period {self.parameters['short_rsi_period']}"
        )
...
class MAEnvelopeStrategy(TradingStrategy):
    ...
    def execute(self):
        print(
            f"Executing MAEnvelope  strategy with ma_period {self.parameters['ma_period']}, buy_margin {self.parameters['buy_margin']}, and sell_margin {self.parameters['sell_margin']}"
        )
...
class BreakoutStrategy(TradingStrategy):
    ...
    def execute(self):
        print(
            f"Executing Breakout strategy with lookback_window {self.parameters['lookback_window']}, buy_margin {self.parameters['buy_margin']}, and sell_margin {self.parameters['sell_margin']}"
        )
